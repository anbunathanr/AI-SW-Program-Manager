...
class TestEstimateDelayDays:
    ...
    def test_estimate_delay_on_track(self):
        ...
        result = estimate_delay_days(
            completion_pct=75.0, time_remaining_days=30, project_id="project-123"
        )
    ...
    def test_estimate_delay_behind_schedule(self):
        ...
        result = estimate_delay_days(
            completion_pct=30.0, time_remaining_days=10, project_id="project-123"
        )
    ...
    def test_estimate_delay_past_due(self):
        ...
        result = estimate_delay_days(
            completion_pct=50.0, time_remaining_days=-5, project_id="project-123"
        )
