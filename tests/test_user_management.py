...
from user_management.handler import (
    create_user,
    list_users,
    update_user_role,
...
class TestCreateUser:
    ...
    def test_create_user_success(
        self, mock_get_cognito, mock_get_dynamodb, admin_event, mock_context, mock_env
    ):
        ...
        mock_cognito.admin_create_user.return_value = {
            "User": {"Username": "newuser@example.com", "Attributes": []}
        }
        ...
        tenant_attr = next(
            attr for attr in user_attrs if attr["Name"] == "custom:tenant_id"
        )
    ...
    def test_create_user_missing_required_fields(
        self, mock_get_cognito, admin_event, mock_context, mock_env
    ):
    ...
    @patch("user_management.handler.get_dynamodb")
    @patch("user_management.handler.get_cognito_client")
    def test_create_user_dynamodb_failure_rollback(
        self, mock_get_cognito, mock_get_dynamodb, admin_event, mock_context, mock_env
    ):
...
class TestListUsers:
    ...
    def test_list_users_with_pagination(
        self, mock_get_dynamodb, mock_context, mock_env
    ):
...
class TestUpdateUserRole:
    ...
    def test_update_user_role_success(
        self, mock_get_cognito, mock_get_dynamodb, mock_context, mock_env
    ):
        ...
        event = {
            ...
            "body": json.dumps({"role": "EXECUTIVE"}),
        }
    ...
    def test_update_user_role_invalid_role(
        ...
        event = {
            ...
            "body": json.dumps({"role": "INVALID_ROLE"}),
        }
    ...
    @patch("user_management.handler.get_dynamodb")
    def test_update_user_role_tenant_isolation(
        self, mock_get_dynamodb, mock_context, mock_env
    ):
