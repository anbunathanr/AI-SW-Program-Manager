        ...
        "body": json.dumps(
            {
                ...
                "authType": "API_TOKEN",
                "credentials": {"apiToken": "test-api-token-12345"},
...
class TestConfigureJiraIntegration:
    ...
    def test_configure_with_api_token_success(
        self, valid_api_token_event, mock_dynamodb, mock_secrets_manager
    ):
    ...
    def test_configure_with_oauth_success(
        self, valid_oauth_event, mock_dynamodb, mock_secrets_manager
    ):
