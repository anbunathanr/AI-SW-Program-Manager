...
class TestDashboardHandlers:
    ...
    def test_get_dashboard_overview_handler_success(self):
        ...
        mock_dashboard_data = {
            ...
            "portfolioHealth": {"overallHealthScore": 85, "overallRagStatus": "GREEN"},
            "recentRisks": [],
            "upcomingMilestones": [],
        }
        ...
        with patch("dashboard.handler.get_cached_data", return_value=None):
            with patch(
                "dashboard.handler.get_dashboard_overview",
    ...
    def test_get_project_dashboard_handler_success(self):
        ...
        with patch("dashboard.handler.get_cached_data", return_value=None):
            with patch(
                "dashboard.handler.get_project_dashboard",
    ...
    def test_get_metrics_handler_success(self):
        ...
        event = {
            "tenant_id": "tenant-123",
            "pathParameters": {"projectId": "proj-1"},
            "queryStringParameters": {"metricType": "velocity", "timeRange": "30d"},
            "requestContext": {"authorizer": {"tenantId": "tenant-123"}},
        }
        context = Mock()
    ...
    def test_get_metrics_handler_invalid_metric_type(self):
        ...
        event = {
            "tenant_id": "tenant-123",
            "pathParameters": {"projectId": "proj-1"},
            "queryStringParameters": {"metricType": "invalid", "timeRange": "30d"},
            "requestContext": {"authorizer": {"tenantId": "tenant-123"}},
        }
        context = Mock()
...
class TestDashboardAggregator:
    ...
    def test_calculate_portfolio_health_empty(self):
        ...
        assert portfolio_health["projectsByStatus"] == {
            "red": 0,
            "amber": 0,
            "green": 0,
        }
    ...
    def test_calculate_portfolio_health_mixed(self):
        ...
        assert (
            portfolio_health["overallHealthScore"] == 73
        )  # (85+70+50+90)/4 = 73.75 -> 73
...
class TestIntegration:
    ...
    def test_get_dashboard_overview_integration(
        ...
        # Mock project query
        mock_execute_query.return_value = [
            {"project_id": "proj-1", "project_name": "Project A", "source": "JIRA"}
        ]
