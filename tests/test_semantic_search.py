...
class TestEmbeddingGenerator:
    ...
    def test_generate_embeddings_success(
        self, mock_opensearch, mock_bedrock, mock_dynamodb
    ):
...
class TestSearchHandler:
    ...
    def test_build_search_query_basic(self):
        ...
        query = build_search_query(
            query_embedding=query_embedding, tenant_id=tenant_id, limit=10
        )
                ...
                "hits": [
                    {
                        ...
                        "highlight": {"text": ["Chunk 1 <mark>content</mark>"]},
                    },
                    {
                        "_score": 0.90,
                        "_source": {
                        ...
                        "highlight": {"text": ["Chunk 2 <mark>content</mark>"]},
                    },
                ],
            }
        }
    ...
    def test_search_handler_success(self, mock_opensearch, mock_bedrock):
                ...
                "hits": [
                    {
                        ...
                        "highlight": {"text": ["<mark>Test</mark> content"]},
                    }
                ],
            }
        }
        ...
        event = {
            "body": json.dumps({"query": "test query", "limit": 10}),
            "requestContext": {
                "authorizer": {
